...
export default function TireDetail({ slug }: { slug: string }) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6 pt-24 md:pt-28">
        ...
        <div className="text-center">
            ...
            <Link href="/pneus" className="bg-primary text-black px-7 py-3 rounded-full font-bold uppercase tracking-widest text-sm">Ver Catálogo Completo</Link>
        </div>
        <Footer />
      </div>
    );
