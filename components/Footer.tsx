  ...
  return (
         ...
         <div className="w-full">
            ...
            <ul className="space-y-6 text-white/80 text-xl font-medium">
               {SERVICES.map(service => (
                 <li key={service.id}>
                    <Link href={`/servico/${service.slug}`} className="hover:text-primary transition-colors flex items-center justify-center md:justify-start gap-3">
               ...
               <li className="pt-8 border-t border-white/10">
                  <Link href="/pneus" className="font-black text-primary hover:text-white transition-colors text-2xl uppercase tracking-tighter italic underline decoration-2 underline-offset-8">Ver Todos os Pneus</Link>
               </li>
            </ul>
         </div>
    ...
    <div className="bg-black py-4 border-t border-white/5">
       <div className="max-w-7xl mx-auto px-4 flex justify-center gap-8 text-[10px] uppercase tracking-[0.2em] font-bold text-white/20">
          ...
          <Link href="/trocas-e-devolucoes" className="hover:text-primary transition-colors">Garantia</Link>
