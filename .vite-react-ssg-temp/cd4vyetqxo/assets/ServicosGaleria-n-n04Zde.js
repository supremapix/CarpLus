...
function getGaleriaServicos(local) {
  return [
    {
...
function getGaleriaSchema(local) {
...
function ServicosGaleria({
  ...
  return /* @__PURE__ */ jsx("section", { className: `py-20 ${bg}`, "aria-labelledby": "galeria-servicos-heading", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-3 mb-6", children: [
        ...
        /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold uppercase tracking-[0.3em] text-gray-400 flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(Wrench, { size: 14, className: "text-primary" }),
          " Nossa Estrutura"
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-12 h-1 bg-primary" })
      ] }),
      /* @__PURE__ */ jsx(
        "h2",
        {
          ...
          children: titulo || /* @__PURE__ */ jsxs(Fragment, { children: [
            "Conheça o Centro Automotivo que Atende",
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-primary italic", children: local })
          ] })
        }
      ),
      /* @__PURE__ */ jsx("p", { className: "text-gray-500 mt-4 max-w-2xl mx-auto text-pretty", children: subtitulo || `Veja a estrutura completa da Carplus: oficina mecânica, montagem de pneus, alinhamento 3D, balanceamento e freios para quem vem do ${local} e região.` })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: imagens.map((img, i) => /* @__PURE__ */ jsxs(
      "figure",
      {
        className: `group relative overflow-hidden rounded-2xl shadow-sm border border-gray-100 ${i === 0 ? "col-span-2 row-span-2 md:col-span-2 md:row-span-2" : ""}`,
        children: [
          /* @__PURE__ */ jsx(
            "img",
            {
              ...
              loading: "lazy",
              decoding: "async",
              className: `w-full object-cover transition-transform duration-500 group-hover:scale-105 ${i === 0 ? "h-full min-h-[260px] md:min-h-[400px]" : "h-44 md:h-52"}`
            }
          ),
          /* @__PURE__ */ jsx("figcaption", { className: "absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-4 pt-10", children: /* @__PURE__ */ jsx("span", { className: "text-white text-sm font-bold leading-tight", children: img.legenda }) })
        ]
      },
      img.src
    )) })
...
export {
  ServicosGaleria as S,
  getGaleriaSchema as g
};
