...
import { MessageCircleQuestion, X, Phone, MapPin, ChevronLeft, ChevronRight, Disc, Car, Settings, Wrench } from "lucide-react";
...
const faqData = [
  ...
  { pergunta: "Tem loja de pneus perto do Portão em Curitiba?", resposta: "Sim, a Carplus Centro Automotivo esta localizada no coracao do bairro Portao, na Rua Padre Anchieta, 2285. Somos a loja de pneus mais completa da regiao, com estoque das principais marcas e servicos de montagem, balanceamento e alinhamento 3D. Facil acesso de toda a zona sul de Curitiba." },
  ...
  { pergunta: "Onde fica a Carplus em Curitiba?", resposta: "A Carplus Centro Automotivo esta localizada na Rua Padre Anchieta, 2285, no bairro Portao, em Curitiba-PR. Estamos em uma regiao de facil acesso, com amplo estacionamento para clientes. Ficamos proximos ao Terminal do Portao e atendemos toda a regiao sul de Curitiba." },
  ...
  { pergunta: "Tem centro automotivo perto do bairro Seminário em Curitiba?", resposta: "A Carplus Centro Automotivo atende a regiao do Seminario. Estamos na Rua Padre Anchieta, 2285, no Portao, a cerca de 10 minutos do Seminario. Somos um centro automotivo completo com pneus, mecanica, alinhamento, balanceamento e mais." },
  ...
  { pergunta: "Tem centro automotivo na região do Portão em Curitiba?", resposta: "Sim, a Carplus e o centro automotivo mais completo do bairro Portao em Curitiba. Estamos na Rua Padre Anchieta, 2285, oferecendo pneus, alinhamento 3D, balanceamento, troca de oleo, manutencao de freios, suspensao, ar condicionado e muito mais." },
...
function FAQModal({ isOpen, onClose, currentIndex, onNavigate }) {
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxs(
        motion.article,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("header", { className: "sticky top-0 z-10 flex items-center justify-between p-4 sm:p-6 border-b border-white/10 bg-[#1a1a1a]/95 backdrop-blur-sm", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx(MessageCircleQuestion, { size: 20, className: "text-primary" }) }),
                /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("span", { className: "text-xs text-white/50 uppercase tracking-wider", children: [
                  "Pergunta ",
                  currentIndex + 1,
                  " de ",
                  faqData.length
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  "aria-label": "Fechar",
                  children: /* @__PURE__ */ jsx(X, { size: 20, className: "text-white/70" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-8", children: [
              /* @__PURE__ */ jsx("h2", { className: "text-xl sm:text-2xl md:text-3xl font-bold text-white mb-6 leading-tight", children: currentFaq.pergunta }),
              /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("p", { className: "text-base sm:text-lg text-white/80 leading-relaxed", children: currentFaq.resposta }) }),
              /* @__PURE__ */ jsxs("div", { className: "mt-8 p-4 sm:p-6 bg-primary/10 border border-primary/30 rounded-xl", children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm text-white/70 mb-3", children: "Ainda tem duvidas? Fale com a gente!" }),
            ...
            /* @__PURE__ */ jsxs("footer", { className: "sticky bottom-0 flex items-center justify-between p-4 sm:p-6 border-t border-white/10 bg-[#1a1a1a]/95 backdrop-blur-sm", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "Anterior" })
                  ]
                }
              ),
              /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1", children: [...Array(Math.min(5, faqData.length))].map((_, i) => {
                const dotIndex = Math.max(0, Math.min(currentIndex - 2, faqData.length - 5)) + i;
                return /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => onNavigate(dotIndex),
                    className: `w-2 h-2 rounded-full transition-all ${dotIndex === currentIndex ? "bg-primary w-6" : "bg-white/30 hover:bg-white/50"}`,
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: "flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors text-white/70 hover:text-white",
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "Proxima" }),
...
function FAQColumn({ questions, duration, columnIndex, onQuestionClick }) {
  const columnRef = useRef(null);
  const visibleQuestions = questions.slice(0, 16);
  const duplicatedQuestions = [...visibleQuestions, ...visibleQuestions];
  const iconComponents = [
    /* @__PURE__ */ jsx(Disc, { size: 14, className: "text-primary shrink-0" }, "disc"),
    /* @__PURE__ */ jsx(Car, { size: 14, className: "text-primary shrink-0" }, "car"),
    /* @__PURE__ */ jsx(Settings, { size: 14, className: "text-primary shrink-0" }, "settings"),
    /* @__PURE__ */ jsx(Wrench, { size: 14, className: "text-primary shrink-0" }, "wrench")
  ];
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: duplicatedQuestions.map((question, index) => /* @__PURE__ */ jsxs(
        "button",
        {
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("header", { className: "text-center mb-12 px-4", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-black text-white uppercase tracking-tight mb-4", children: [
            "Duvidas ",
            /* @__PURE__ */ jsx("span", { className: "text-primary italic", children: "Frequentes" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "w-24 h-1 bg-primary mx-auto rounded-full" }),
          /* @__PURE__ */ jsx("p", { className: "text-white/50 mt-4 max-w-2xl mx-auto", children: "As perguntas mais comuns sobre pneus, servicos automotivos e nossa loja em Curitiba. Clique em qualquer pergunta para ver a resposta completa." })
        ] }),
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-4 max-w-7xl mx-auto", children: [
              /* @__PURE__ */ jsx(FAQColumn, { questions: column1Questions, duration: 30, columnIndex: 0, onQuestionClick: handleQuestionClick }),
              /* @__PURE__ */ jsx(FAQColumn, { questions: column2Questions, duration: 38, columnIndex: 1, onQuestionClick: handleQuestionClick }),
              /* @__PURE__ */ jsx(FAQColumn, { questions: column3Questions, duration: 34, columnIndex: 2, onQuestionClick: handleQuestionClick }),
              /* @__PURE__ */ jsx(FAQColumn, { questions: column4Questions, duration: 42, columnIndex: 3, onQuestionClick: handleQuestionClick })
            ] })
          }
        ),
        /* @__PURE__ */ jsx(
