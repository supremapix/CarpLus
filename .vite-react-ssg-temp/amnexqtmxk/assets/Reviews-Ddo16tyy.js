...
import { Star, ArrowUp, X, ChevronLeft, ChevronRight } from "lucide-react";
...
function GoogleLogo$1() {
  return /* @__PURE__ */ jsxs("svg", { width: "26", height: "26", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: [
...
function ReviewsHeader({ reviewCount = 227 }) {
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-[380px]", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(GoogleLogo$1, {}),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col gap-1", children: [
            /* @__PURE__ */ jsx("div", { className: "flex gap-0.5", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsx(Star, { size: 18, fill: "#FACC15", color: "#FACC15", "aria-hidden": "true" }, i)) }),
            /* @__PURE__ */ jsx("span", { className: "text-[13px] font-medium text-[#202124]", children: "4,9 de 5 estrelas" })
          ] }),
          /* @__PURE__ */ jsx("span", { className: "h-1 w-1 flex-shrink-0 rounded-full bg-gray-400", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxs("span", { className: "flex flex-shrink-0 items-center gap-1 text-[13px] text-gray-500", children: [
            reviewCount,
            " avaliações",
            /* @__PURE__ */ jsx(
              motion.span,
              {
                ...
                children: /* @__PURE__ */ jsx(ArrowUp, { size: 14, strokeWidth: 3, "aria-hidden": "true" })
              }
            )
          ] })
        ]
    ...
    /* @__PURE__ */ jsxs(
      motion.h2,
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "block", children: "O QUE NOSSOS" }),
          /* @__PURE__ */ jsx("span", { className: "block italic text-[#F59E0B]", children: "CLIENTES DIZEM" })
        ]
      }
    )
  ] });
...
const getTimeAgo = (index) => TIME_OPTIONS[index % TIME_OPTIONS.length];
const ALL_REVIEWS = [
  {
    name: "Isaac Coelho",
...
function GoogleLogo() {
  return /* @__PURE__ */ jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: [
    /* @__PURE__ */ jsx("path", { d: "M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z", fill: "#4285F4" }),
    /* @__PURE__ */ jsx("path", { d: "M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z", fill: "#34A853" }),
    /* @__PURE__ */ jsx("path", { d: "M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z", fill: "#FBBC05" }),
    /* @__PURE__ */ jsx("path", { d: "M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z", fill: "#EA4335" })
...
function ReviewCard({ review, colorIdx, reviewIdx, onClick }) {
  const avatarIdx = review.avatarColorIdx !== void 0 ? review.avatarColorIdx : colorIdx;
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-[#202124] font-medium text-sm truncate leading-tight", children: review.name }),
              /* @__PURE__ */ jsx("p", { className: "text-[#70757a] text-[11px] truncate leading-tight", children: getTimeAgo(reviewIdx) })
            ] })
          ] }),
          /* @__PURE__ */ jsx(GoogleLogo, {})
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 mb-2", children: [
          /* @__PURE__ */ jsx("div", { className: "flex gap-0.5", children: [...Array(review.stars)].map((_, j) => /* @__PURE__ */ jsx(Star, { size: 13, fill: "#fbbc04", color: "#fbbc04" }, j)) }),
          /* @__PURE__ */ jsx("span", { className: "text-[#70757a] text-[11px]", children: "Google" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-[#3c4043] text-[13px] leading-relaxed line-clamp-3", children: review.text })
      ]
    }
  );
}
function ReviewColumn({ reviews, duration, delay = 0, offset = 0, onReviewClick }) {
  const visible = reviews.slice(0, 4);
  const doubled = [...visible, ...visible];
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3 overflow-hidden", style: { maxHeight: "680px" }, children: /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: doubled.map((r, i) => /* @__PURE__ */ jsx(
        ReviewCard,
        {
          review: r,
          colorIdx: (i + offset) % 6,
...
function Reviews() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "py-24 bg-[#f8f9fa] relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 relative z-10", children: [
      /* @__PURE__ */ jsx("div", { className: "md:hidden mb-14", children: /* @__PURE__ */ jsx(ReviewsHeader, { reviewCount: TOTAL_REVIEWS }) }),
      /* @__PURE__ */ jsxs("div", { className: "hidden md:block text-center md:text-left max-w-[640px] mb-14 mx-auto md:mx-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-3 bg-white border border-gray-200 shadow-sm px-5 py-2.5 rounded-full mb-6 mx-auto md:mx-0", children: [
          /* @__PURE__ */ jsx(GoogleLogo, {}),
          /* @__PURE__ */ jsx("div", { className: "flex gap-0.5", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsx(Star, { size: 14, fill: "#fbbc04", color: "#fbbc04" }, i)) }),
          /* @__PURE__ */ jsx("span", { className: "text-[#202124] font-semibold text-sm", children: "4,9 DE 5 ESTRELAS" }),
          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 text-[#70757a] text-sm", children: [
            "• ",
            TOTAL_REVIEWS,
            " avaliações",
            /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center md:items-start", children: [
          /* @__PURE__ */ jsx(SectionTitle, { prefix: "O QUE NOSSOS CLIENTES", highlight: "DIZEM" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-lg sm:text-xl md:text-2xl font-light text-center md:text-left", children: "Transparência em cada diagnóstico, satisfação em cada entrega." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 [mask-image:linear-gradient(to_bottom,transparent,black_8%,black_92%,transparent)]", children: [
        /* @__PURE__ */ jsx(ReviewColumn, { reviews: COL1, duration: 60, delay: 0, offset: 0, onReviewClick: openReview }),
        /* @__PURE__ */ jsx(ReviewColumn, { reviews: COL2, duration: 55, delay: -15, offset: 2, onReviewClick: openReview }),
        /* @__PURE__ */ jsx("div", { className: "hidden lg:block", children: /* @__PURE__ */ jsx(ReviewColumn, { reviews: COL3, duration: 65, delay: -30, offset: 4, onReviewClick: openReview }) }),
        /* @__PURE__ */ jsx("div", { className: "hidden lg:block", children: /* @__PURE__ */ jsx(ReviewColumn, { reviews: COL4, duration: 50, delay: -10, offset: 1, onReviewClick: openReview }) })
      ] }),
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { children: selectedReview && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[999] flex items-center justify-center p-4", children: [
      /* @__PURE__ */ jsx(
        motion.div,
        {
          initial: { opacity: 0 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-8 sm:p-12", children: [
              /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                selectedReview.review.avatar ? /* @__PURE__ */ jsx(
                  "img",
                  {
                    loading: "lazy",
                  ...
                  "div",
                  {
                    ...
                    children: selectedReview.review.name[0]
                  }
                ),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-dark", children: selectedReview.review.name }),
                  /* @__PURE__ */ jsxs("p", { className: "text-gray-500 text-sm flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx(GoogleLogo, {}),
                    " Local Guide • ",
                    getTimeAgo(selectedReview.index)
                  ] })
                ] })
              ] }) }),
              /* @__PURE__ */ jsx("div", { className: "flex gap-1 mb-6", children: [...Array(selectedReview.review.stars)].map((_, j) => /* @__PURE__ */ jsx(Star, { size: 24, fill: "#fbbc04", color: "#fbbc04" }, j)) }),
              /* @__PURE__ */ jsxs("p", { className: "text-gray-700 text-lg sm:text-xl leading-relaxed italic font-medium", children: [
                '"',
                selectedReview.review.text,
                '"'
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mt-12 pt-8 border-t border-gray-100", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: prevReview,
                    ...
                    children: [
                      /* @__PURE__ */ jsx(ChevronLeft, { size: 24, className: "group-hover:-translate-x-1 transition-transform" }),
                      "Anterior"
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs("div", { className: "text-gray-300 font-mono text-sm", children: [
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      "Próximo",
                      /* @__PURE__ */ jsx(ChevronRight, { size: 24, className: "group-hover:translate-x-1 transition-transform" })
                    ]
                  }
                )
              ] })
