...
export default function BrandsCarousel() {
  return (
    <section className="bg-dark pt-16 md:pt-0 md:pb-0 overflow-hidden relative border-b border-white/10 min-h-[600px] md:min-h-0" id="especialista">
      ...
      {/* Background Image - Maurício */}
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        {/* Desktop gradient: esquerda para direita */}
        <div className="hidden md:block absolute inset-0 bg-gradient-to-r from-dark via-dark/80 via-50% to-dark/20 z-10" />
        ...
        <div className="flex flex-col md:grid md:grid-cols-[1.2fr_1fr] items-center gap-12 lg:gap-24">
          ...
          <div className="w-full space-y-8 md:space-y-10 order-1 text-center md:text-left relative">
            ...
            <motion.div
                ...
                className="space-y-6"
            >
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white font-display font-black leading-[0.95] uppercase italic tracking-tighter">
                   FALE COM UM<br/>
