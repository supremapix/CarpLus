...
export default function ReturnPolicy() {
  useSEO({
    ...
    description: 'Política de trocas, devoluções e garantia da Carplus Pneus e Oficina Mecânica: garantia de fábrica nos pneus e 90 dias nos serviços de oficina, conforme o CDC.',
    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="pt-32 md:pt-36 pb-24 max-w-4xl mx-auto px-4">
        ...
        <div className="prose prose-lg text-gray-600 space-y-6">
          <p>A Carplus Pneus e Oficina Mecânica preza pela transparência e satisfação total dos nossos clientes de Curitiba e região.</p>
