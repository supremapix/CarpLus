...
const faqData: FAQItem[] = [
  ...
  { pergunta: "A Carplus tem pneu com montagem inclusa?", resposta: "Sim, na Carplus Auto Center a montagem e balanceamento estao sempre inclusos na compra de pneus novos. Utilizamos equipamentos de ultima geracao para garantir um servico perfeito. Voce so paga pelo alinhamento se desejar, mas recomendamos fazer junto para garantir a durabilidade dos pneus novos e a seguranca do veiculo." },
  ...
  { pergunta: "Tem loja de pneus perto do Portão em Curitiba?", resposta: "Sim, a Carplus Auto Center esta localizada no coracao do bairro Portao, na Rua Padre Anchieta, 2285. Somos a loja de pneus mais completa da regiao, com estoque das principais marcas e servicos de montagem, balanceamento e alinhamento 3D. Facil acesso de toda a zona sul de Curitiba." },
  ...
  { pergunta: "Tem auto center perto do bairro Seminário em Curitiba?", resposta: "A Carplus Auto Center atende a regiao do Seminario. Estamos na Rua Padre Anchieta, 2285, no Portao, a cerca de 10 minutos do Seminario. Somos um auto center completo com pneus, mecanica, alinhamento, balanceamento e mais." },
  ...
  { pergunta: "Qual a melhor oficina mecânica perto do Portão?", resposta: "A Carplus Auto Center e referencia em servicos automotivos no Portao. Com equipe qualificada, equipamentos modernos e pecas de qualidade, oferecemos atendimento de excelencia. Estamos na Rua Padre Anchieta, 2285. Venha conhecer e comprove!" },
