...
const faqData: FAQItem[] = [
  // Perguntas de alta intencao comercial — ficam no inicio de proposito, pois o
  // FAQPage JSON-LD abaixo usa faqData.slice(0, 50) e estas sao as que devem
  // aparecer nos rich results do Google.
  { pergunta: "Onde instalar pneus em Curitiba?", resposta: "Voce pode comprar e instalar seus pneus no mesmo lugar na Carplus Centro Automotivo, na Av. Arthur da Silva Bernardes, 1323, bairro Portao, em Curitiba. Somos loja e distribuidora de pneus com instalacao inclusa: montagem, balanceamento e alinhamento 3D feitos por tecnicos especializados, com equipamento computadorizado. Atendemos de segunda a sexta das 8h as 18h e sabado das 8h as 13h, com estacionamento proprio. Ligue (41) 3082-7282 ou faca seu orcamento pelo WhatsApp." },
  { pergunta: "Onde trocar pneus em Curitiba com montagem inclusa?", resposta: "Na Carplus, a montagem e o balanceamento estao sempre inclusos na compra de pneus novos, sem custo adicional. Estamos no bairro Portao, na Av. Arthur da Silva Bernardes, 1323, com facil acesso de toda a regiao sul de Curitiba. A troca dos 4 pneus com balanceamento leva de 40 minutos a 1 hora, e voce pode agendar para nao esperar. Parcelamos em ate 10x sem juros no cartao." },
  { pergunta: "Qual a melhor loja de pneus em Curitiba?", resposta: "A Carplus Centro Automotivo tem nota 4,9 no Google com mais de 227 avaliacoes e mais de 35 anos de experiencia no mercado automotivo de Curitiba. Somos revendedor autorizado das principais marcas (Michelin, Pirelli, Goodyear, Bridgestone, Continental e Yokohama), trabalhamos apenas com pneus novos e originais com nota fiscal e garantia de fabrica, e entregamos pneu e instalacao no mesmo lugar. Estamos no Portao, na Av. Arthur da Silva Bernardes, 1323." },
  { pergunta: "Existe distribuidora de pneus em Curitiba?", resposta: "Sim. A Carplus atua como loja e distribuidora de pneus em Curitiba, com estoque das principais marcas e medidas do aro 14 ao aro 23 para carros, SUVs e picapes. Por trabalharmos com volume, conseguimos precos competitivos e pronta entrega nas medidas mais procuradas. Atendemos clientes finais e frotas no bairro Portao, na Av. Arthur da Silva Bernardes, 1323 — consulte disponibilidade pelo (41) 3082-7282." },
  { pergunta: "Onde comprar pneus baratos em Curitiba sem perder qualidade?", resposta: "Na Carplus voce encontra pneus de primeira linha com preco justo, porque a montagem e o balanceamento ja estao inclusos — nao existe custo escondido depois da compra. Trabalhamos com opcoes para todos os orcamentos, de marcas de entrada com bom custo-beneficio ate linhas premium, sempre com pneus novos, originais e com garantia de fabrica. Parcelamos em ate 10x sem juros. Faca um orcamento sem compromisso pelo WhatsApp." },
  { pergunta: "Preciso agendar para trocar pneu na Carplus?", resposta: "Nao e obrigatorio, atendemos por ordem de chegada, mas o agendamento e recomendado para voce nao esperar. Estamos abertos de segunda a sexta das 8h as 18h e sabado das 8h as 13h, na Av. Arthur da Silva Bernardes, 1323, no Portao. Agende pelo telefone (41) 3082-7282 ou pelo WhatsApp e ja deixamos a medida do seu pneu separada." },
  // Coluna 1 - Pneus
  ...
  { pergunta: "Onde comprar pneu Pirelli em Curitiba?", resposta: "A Carplus Centro Automotivo e revendedor autorizado Pirelli em Curitiba, localizada no bairro Portao. Trabalhamos com toda a linha Pirelli: Cinturato P1, P7, Scorpion, P Zero e mais. Oferecemos garantia de fabrica, montagem profissional e os melhores precos da regiao. Visite nossa loja na Av. Arthur da Silva Bernardes, 1323 ou solicite orcamento pelo WhatsApp." },
  { pergunta: "Onde comprar pneu Michelin no Portão?", resposta: "No bairro Portao em Curitiba, a Carplus Centro Automotivo e a melhor opcao para pneus Michelin. Temos toda a linha: Primacy, Pilot Sport, CrossClimate e Agilis. Somos especializados em atendimento personalizado, com montagem e balanceamento inclusos. Estamos na Av. Arthur da Silva Bernardes, 1323 - facil acesso de toda regiao sul de Curitiba." },
  ...
  { pergunta: "A Carplus tem pneu com montagem inclusa?", resposta: "Sim, na Carplus Centro Automotivo a montagem e balanceamento estao sempre inclusos na compra de pneus novos. Utilizamos equipamentos de ultima geracao para garantir um servico perfeito. Voce so paga pelo alinhamento se desejar, mas recomendamos fazer junto para garantir a durabilidade dos pneus novos e a seguranca do veiculo." },
  ...
  { pergunta: "Tem loja de pneus perto do Portão em Curitiba?", resposta: "Sim, a Carplus Centro Automotivo esta localizada no coracao do bairro Portao, na Av. Arthur da Silva Bernardes, 1323. Somos a loja de pneus mais completa da regiao, com estoque das principais marcas e servicos de montagem, balanceamento e alinhamento 3D. Facil acesso de toda a zona sul de Curitiba." },
  ...
  { pergunta: "Onde fazer diagnóstico automotivo no Portão?", resposta: "A Carplus Centro Automotivo no bairro Portao oferece diagnostico automotivo completo com scanner profissional multimarcas. Estamos na Av. Arthur da Silva Bernardes, 1323, com facil estacionamento. Nossa equipe identifica o problema e indica a solucao mais economica e segura para seu veiculo." },
  ...
  { pergunta: "Revisão no Portão tem na Carplus?", resposta: "Sim, a Carplus Centro Automotivo no bairro Portao oferece servico completo de revisao automotiva. Estamos na Av. Arthur da Silva Bernardes, 1323, com facil acesso e estacionamento. Realizamos desde revisoes basicas ate revisoes completas seguindo as especificacoes do fabricante." },
  ...
  { pergunta: "Onde fica a Carplus em Curitiba?", resposta: "A Carplus Centro Automotivo esta localizada na Av. Arthur da Silva Bernardes, 1323, no bairro Portao, em Curitiba-PR. Estamos em uma regiao de facil acesso, com amplo estacionamento para clientes. Ficamos proximos ao Terminal do Portao e atendemos toda a regiao sul de Curitiba." },
  { pergunta: "A Carplus fica no bairro Portão?", resposta: "Sim, a Carplus esta localizada no coracao do bairro Portao, um dos mais tradicionais de Curitiba. Nosso endereco e Av. Arthur da Silva Bernardes, 1323. Estamos a poucos minutos do Terminal do Portao e atendemos moradores de toda a regiao." },
  { pergunta: "A Carplus atende o bairro Água Verde?", resposta: "Sim, o bairro Agua Verde esta muito proximo da Carplus. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 5 minutos de carro do Agua Verde. Muitos de nossos clientes sao moradores deste bairro vizinho." },
  { pergunta: "Tem oficina mecânica no Novo Mundo perto da Carplus?", resposta: "A Carplus esta no bairro Portao, muito proximo ao Novo Mundo. Estamos na Av. Arthur da Silva Bernardes, 1323, a cerca de 10 minutos do Novo Mundo. Oferecemos servicos completos de mecanica, pneus, alinhamento, balanceamento e muito mais." },
  { pergunta: "A Carplus atende clientes do bairro Fazendinha?", resposta: "Sim, atendemos clientes de toda Curitiba, incluindo o bairro Fazendinha. A Carplus esta na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 15 minutos da Fazendinha. Temos facil acesso e estacionamento proprio." },
  { pergunta: "Tem troca de pneu no bairro Campo Comprido?", resposta: "A Carplus atende clientes do Campo Comprido e regiao. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 20 minutos do Campo Comprido. Oferecemos pneus das melhores marcas com montagem, balanceamento e alinhamento." },
  { pergunta: "Oficina mecânica no bairro Lindóia — a Carplus atende?", resposta: "Sim, atendemos clientes do bairro Lindoia. A Carplus esta no Portao, na Av. Arthur da Silva Bernardes, 1323, a cerca de 15 minutos do Lindoia. Oferecemos todos os servicos de mecanica, pneus e manutencao automotiva." },
  { pergunta: "Tem centro automotivo perto do bairro Seminário em Curitiba?", resposta: "A Carplus Centro Automotivo atende a regiao do Seminario. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 10 minutos do Seminario. Somos um centro automotivo completo com pneus, mecanica, alinhamento, balanceamento e mais." },
  { pergunta: "A Carplus fica próxima ao bairro Vila Izabel?", resposta: "Sim, estamos relativamente proximos a Vila Izabel. A Carplus fica na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 12 minutos da Vila Izabel. Atendemos clientes de toda a regiao com servicos completos." },
  { pergunta: "Qual a distância da Carplus para o bairro Guabirotuba?", resposta: "Do bairro Guabirotuba ate a Carplus no Portao sao aproximadamente 20 minutos de carro via Av. Marechal Floriano Peixoto. Estamos na Av. Arthur da Silva Bernardes, 1323, com facil estacionamento e atendimento profissional." },
  { pergunta: "Tem loja de pneus perto do bairro Pinheirinho?", resposta: "A Carplus atende clientes do Pinheirinho. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 15 minutos do Pinheirinho. Oferecemos pneus das melhores marcas com precos competitivos e servicos inclusos." },
  { pergunta: "Oficina mecânica próxima ao Santa Quitéria?", resposta: "A Carplus esta no Portao, muito proximo ao Santa Quiteria. Nosso endereco e Av. Arthur da Silva Bernardes, 1323, a cerca de 8 minutos do Santa Quiteria. Oferecemos todos os servicos de mecanica e pneus que voce precisa." },
  { pergunta: "A Carplus atende o bairro Parolin?", resposta: "Sim, atendemos clientes do bairro Parolin. A Carplus esta na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 15 minutos do Parolin. Venha conhecer nossa estrutura e servicos de qualidade." },
  { pergunta: "Tem mecânico de confiança perto do bairro Capão Raso?", resposta: "A Carplus atende clientes do Capao Raso e regiao. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 12 minutos. Somos uma oficina de confianca com mais de X anos de experiencia e clientes satisfeitos." },
  { pergunta: "Oficina no bairro Xaxim tem na Carplus?", resposta: "Atendemos clientes do bairro Xaxim. A Carplus esta localizada na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 15 minutos do Xaxim. Oferecemos servicos completos de mecanica, pneus, alinhamento e balanceamento." },
  { pergunta: "A Carplus está perto do bairro Boqueirão?", resposta: "A Carplus atende clientes do Boqueirao. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao, a cerca de 25 minutos do Boqueirao. Vale a pena o deslocamento pela qualidade dos nossos servicos e precos competitivos." },
  { pergunta: "Tem centro automotivo na região do Portão em Curitiba?", resposta: "Sim, a Carplus e o centro automotivo mais completo do bairro Portao em Curitiba. Estamos na Av. Arthur da Silva Bernardes, 1323, oferecendo pneus, alinhamento 3D, balanceamento, troca de oleo, manutencao de freios, suspensao, ar condicionado e muito mais." },
  { pergunta: "Qual a melhor oficina mecânica perto do Portão?", resposta: "A Carplus Centro Automotivo e referencia em servicos automotivos no Portao. Com equipe qualificada, equipamentos modernos e pecas de qualidade, oferecemos atendimento de excelencia. Estamos na Av. Arthur da Silva Bernardes, 1323. Venha conhecer e comprove!" },
  { pergunta: "Onde resolver pneu furado rápido no Portão?", resposta: "Na Carplus voce resolve pneu furado rapidamente. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao. O reparo de pneu furado leva cerca de 20 minutos. Se o pneu nao tiver conserto, temos diversas opcoes para substituicao imediata." },
  { pergunta: "Pneu furado no Portão — a Carplus resolve?", resposta: "Sim, a Carplus resolve pneu furado com rapidez e qualidade. Estamos no Portao, Av. Arthur da Silva Bernardes, 1323. Fazemos reparo de furo (quando possivel) ou substituicao do pneu. Temos estoque das principais medidas para pronta entrega." },
  { pergunta: "Como resolver pneu furado em Curitiba?", resposta: "Se voce furou o pneu em Curitiba, troque pelo estepe (se possivel) e venha ate a Carplus no Portao, Av. Arthur da Silva Bernardes, 1323. Avaliamos se o pneu tem conserto ou se precisa ser substituido. Atendimento rapido e precos justos." },
  ...
  { pergunta: "Pneu furado no centro de Curitiba — onde ir?", resposta: "Se voce furou o pneu no centro de Curitiba, a Carplus no Portao e uma otima opcao. Estamos na Av. Arthur da Silva Bernardes, 1323, a cerca de 15 minutos do centro. Atendimento rapido e profissional para resolver seu problema." },
  ...
  { pergunta: "A Carplus tem estacionamento fácil?", resposta: "Sim, a Carplus tem estacionamento proprio e amplo para clientes. Voce pode deixar o carro com tranquilidade enquanto aguarda o servico ou deixar para buscar depois. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao." },
  ...
  { pergunta: "Tem mecânica full service perto do Portão?", resposta: "Sim, a Carplus e uma mecanica full service no Portao. Oferecemos todos os servicos automotivos em um so lugar: pneus, alinhamento, balanceamento, troca de oleo, freios, suspensao, ar condicionado, scanner e muito mais. Av. Arthur da Silva Bernardes, 1323." },
  { pergunta: "O que é centro automotivo full service?", resposta: "Centro Automotivo full service e uma oficina que oferece todos os servicos automotivos em um unico local: pneus, alinhamento, balanceamento, mecanica geral, eletrica, ar condicionado, freios, suspensao e mais. A Carplus e um centro automotivo full service completo no Portao." },
...
const column4Questions = [
  ...
  "Tem centro automotivo perto do bairro Seminário em Curitiba?",
  ...
  "Tem centro automotivo na região do Portão em Curitiba?",
  ...
  "O que é centro automotivo full service?",
