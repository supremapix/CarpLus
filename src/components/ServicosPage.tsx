...
export default function ServicosPage() {
  ...
  // SEO
  useSEO({
    title: 'Serviços de Pneus e Oficina Mecânica em Curitiba | Carplus Auto Center',
    description: 'Serviços completos de oficina mecânica e pneus em Curitiba: alinhamento 3D, balanceamento, troca de pneus, revisão, freios, suspensão, diagnóstico eletrônico e muito mais. Portão, Curitiba.',
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="pt-28 pb-12 px-4 bg-[#0a0a0a] text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter text-white leading-none mb-4 italic">
      ...
      <section className="py-16 px-4 bg-primary">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black uppercase tracking-tighter text-black mb-4 italic leading-tight">
            Pronto para agendar?
          </h2>
