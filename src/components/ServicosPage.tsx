...
export default function ServicosPage() {
  ...
  useSEO({
    title: 'Serviços de Oficina e Pneus em Curitiba Portão | Carplus Pneus e Oficina Mecânica',
    description: 'Alinhamento 3D, troca de pneus, óleo, suspensão e freios em Curitiba. Carplus Pneus e Oficina Mecânica no Portão – agende pelo (41) 3082-7282.',
