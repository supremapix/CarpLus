    ...
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden bg-dark">
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-36 pb-24 md:pt-40 md:pb-28">
        <motion.div 
          ...
          className="max-w-2xl"
        >
          <h1 className="text-[2.5rem] sm:text-6xl md:text-7xl lg:text-8xl text-white mb-2 leading-[0.9] font-bold text-center md:text-left">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-6 mt-6">
            {[
              ...
              <div key={i} className="flex items-center gap-2 text-white/80 border-l border-primary pl-4 py-2">
