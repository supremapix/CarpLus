    ...
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden bg-dark">
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-36 pb-24 md:pt-40 md:pb-28">
        <motion.div 
          ...
          className="max-w-2xl"
        >
          <h1 className="text-[2.5rem] sm:text-6xl md:text-7xl lg:text-8xl text-white mb-2 leading-[0.9] font-bold text-center">
            PNEUS <span className="text-primary">EM CURITIBA</span>
          </h1>
          <h2 className="text-sm sm:text-base md:text-3xl text-white font-display font-bold uppercase tracking-tight mb-8 text-center">
