      ...
      <div className="bg-primary text-white py-1.5 px-4 text-[10px] md:text-xs font-medium">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-4">
            <span className="flex items-center gap-1"><Clock size={12} /> Seg-Sex 8h-18h | Sáb 8h-13h</span>
          </div>
        </div>
      </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex justify-between items-center mb-8 bg-black/30 p-4 rounded-3xl border border-white/5">
              <img src="https://lp.carpluscwb.com.br/wp-content/uploads/2025/08/carplus-pneus-oficina-mecanica-full-service-horizontal.svg" alt="Logo" className="h-10 md:h-12" />
              <button onClick={() => setIsMobileMenuOpen(false)} className="bg-white/10 p-2 rounded-xl"><X size={32} /></button>
            </div>
