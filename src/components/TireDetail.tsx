...
export default function TireDetail() {
    ...
    if (navigator.share && tire) {
      try {
        await navigator.share({
          title: tire.nome,
          text: `Confira o pneu ${tire.nome} na Carplus Pneus e Oficina Mecânica em Curitiba!`,
          url: shareUrl,
        });
      } catch (err) {
  ...
  useSEO(
    tire
      ? {
          title: `${tire.nome} em Curitiba | Carplus Pneus e Oficina Mecânica – Portao`,
            ...
            {showShareMenu && (
              <div className="absolute right-0 top-full mt-2 bg-white rounded-2xl shadow-2xl border border-gray-100 p-4 z-50 min-w-[280px]">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <a
                    href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Confira o pneu ${tire?.nome} na Carplus Pneus e Oficina Mecânica!`)}&url=${encodeURIComponent(shareUrl)}`}
                    target="_blank"
                    rel="noopener noreferrer"
