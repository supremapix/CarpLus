...
const faqData: FAQItem[] = [
  ...
  { categoria: "Carplus", pergunta: "Onde fica a Carplus em Curitiba?", resposta: "A Carplus Centro Automotivo esta localizada na Av. Arthur da Silva Bernardes, 1323, no bairro Portao, em Curitiba-PR. Estamos em uma regiao de facil acesso, com amplo estacionamento para clientes. Ficamos proximos ao Terminal do Portao e atendemos toda a regiao sul de Curitiba." },
  { categoria: "Carplus", pergunta: "A Carplus fica no bairro Portao?", resposta: "Sim, a Carplus esta localizada no coracao do bairro Portao, um dos mais tradicionais de Curitiba. Nosso endereco e Av. Arthur da Silva Bernardes, 1323. Estamos a poucos minutos do Terminal do Portao e atendemos moradores de toda a regiao." },
  ...
  { categoria: "Carplus", pergunta: "A Carplus tem estacionamento facil?", resposta: "Sim, a Carplus tem estacionamento proprio e amplo para clientes. Voce pode deixar o carro com tranquilidade enquanto aguarda o servico ou deixar para buscar depois. Estamos na Av. Arthur da Silva Bernardes, 1323, no Portao." },
  ...
  // Pneu Furado
  { categoria: "Pneu Furado", pergunta: "Pneu furado no Portao a Carplus resolve?", resposta: "Sim, a Carplus resolve pneu furado com rapidez e qualidade. Estamos no Portao, Av. Arthur da Silva Bernardes, 1323. Fazemos reparo de furo (quando possivel) ou substituicao do pneu. Temos estoque das principais medidas para pronta entrega." },
...
const categoryIcons: Record<string, React.ReactNode> = {
  ...
  "Freios": <Car size={16} />,
  "Suspensao": <Wrench size={16} />,
  "Ar Condicionado": <Settings size={16} />,
  "Revisao": <Wrench size={16} />,
  "Diagnostico": <Settings size={16} />,
  "Carplus": <MapPin size={16} />,
  "Pneu Furado": <Disc size={16} />,
};
...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Categories */}
      <section className="sticky top-[72px] sm:top-[108px] z-30 bg-[#0f0f0f]/98 backdrop-blur-md border-b border-white/10 py-3 sm:py-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex gap-2 overflow-x-auto px-4 pb-2 scrollbar-hide" style={{ WebkitOverflowScrolling: 'touch' }}>
            {categorias.map((cat) => (
              <button
                key={cat}
                    ...
                    {openIndex === index && (
                      ...
                      >
                        <div className="px-5 pb-5 pt-0">
                          <div className="pl-7 border-l-2 border-primary/30">
                            <p 
                            ...
                            <div className="mt-4 flex items-center gap-2">
                              <span className="inline-flex items-center gap-1 px-3 py-1 bg-primary/10 border border-primary/20 rounded-full text-xs text-primary">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-12">
            ...
            <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-6">
              ...
              <p className="text-white/50 text-sm">Av. Arthur da Silva Bernardes, 1323</p>
            </div>
          </div>
        </div>
      </section>
