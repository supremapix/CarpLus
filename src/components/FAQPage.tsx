...
const faqData: FAQItem[] = [
  ...
  { categoria: "Pneus", pergunta: "Onde comprar pneu Pirelli em Curitiba?", resposta: "A Carplus Pneus e Oficina Mecânica e revendedor autorizado Pirelli em Curitiba, localizada no bairro Portao. Trabalhamos com toda a linha Pirelli: Cinturato P1, P7, Scorpion, P Zero e mais. Oferecemos garantia de fabrica, montagem profissional e os melhores precos da regiao. Visite nossa loja na Rua Padre Anchieta ou solicite orcamento pelo WhatsApp." },
  ...
  { categoria: "Carplus", pergunta: "Onde fica a Carplus em Curitiba?", resposta: "A Carplus Pneus e Oficina Mecânica esta localizada na Rua Padre Anchieta, 2285, no bairro Portao, em Curitiba-PR. Estamos em uma regiao de facil acesso, com amplo estacionamento para clientes. Ficamos proximos ao Terminal do Portao e atendemos toda a regiao sul de Curitiba." },
...
export default function FAQPage() {
  ...
  useEffect(() => {
    document.title = 'FAQ - Perguntas Frequentes | Carplus Pneus e Oficina Mecânica Curitiba';
    ...
    desc.setAttribute(
      'content',
      'Perguntas frequentes sobre pneus, alinhamento 3D, balanceamento, freios, suspensão e serviços automotivos da Carplus Pneus e Oficina Mecânica no Portão, Curitiba.'
    );
  ...
  const faqSchemaData = {
    ...
    "@type": "FAQPage",
    "name": "Perguntas Frequentes - Carplus Pneus e Oficina Mecânica Curitiba",
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
              Encontre respostas para suas duvidas sobre pneus, servicos automotivos, precos e atendimento da Carplus Pneus e Oficina Mecânica em Curitiba.
            </p>
