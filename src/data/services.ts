// Dados completos de serviços da Carplus Centro Automotivo
...
// Helper para obter todos os servicos em um array flat
export function getAllServices(): (Service & { categoryId: string; categoryName: string })[] {
...
// Helper para buscar um servico pelo slug
export function getServiceBySlug(slug: string): (Service & { categoryId: string; categoryName: string }) | undefined {
  return getAllServices().find(s => s.slug === slug);
}

// Helper para buscar servicos por categoria
